        ...
        <footer className="bg-neutro-tertiary">
            <div className="text-white flex max-md:flex-col mx-auto gap-4 justify-between items-center p-4 lg:p-6 lg:justify-center">
                <nav className="flex md:order-1">
                    <a href={facebookUrl} target="_blank" rel="noopener noreferrer" className="p-2 hover:scale-125 transition-transform duration-300">
                        <svg className="w-6 lg:w-[28px]" stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M504 256C504 119 393 8 256 8S8 119 8 256c0 123.78 90.69 226.38 209.25 245V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.28c-30.8 0-40.41 19.12-40.41 38.73V256h68.78l-11 71.69h-57.78V501C413.31 482.38 504 379.78 504 256z"></path></svg>
                    </a>
                    <a href={instagramUrl} target="_blank" rel="noopener noreferrer" className="p-2 ml-4 hover:scale-125 transition-transform duration-300">
                    ...
                    <a href={universityUrl} target="_blank" rel="noopener noreferrer" className="p-2 ml-4 hover:scale-125 transition-transform duration-300">
                        <svg className="w-6 lg:w-[28px]" stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M496 128v16a8 8 0 0 1-8 8h-24v12c0 6.627-5.373 12-12 12H60c-6.627 0-12-5.373-12-12v-12H24a8 8 0 0 1-8-8v-16a8 8 0 0 1 4.941-7.392l232-88a7.996 7.996 0 0 1 6.118 0l232 88A8 8 0 0 1 496 128zm-24 304H40c-13.255 0-24 10.745-24 24v16a8 8 0 0 0 8 8h464a8 8 0 0 0 8-8v-16c0-13.255-10.745-24-24-24zM96 192v192H60c-6.627 0-12 5.373-12 12v20h416v-20c0-6.627-5.373-12-12-12h-36V192h-64v192h-64V192h-64v192h-64V192H96z"></path></svg>
                    </a>
                </nav>
